function GoEasy() {
  ...
  !function (t, e) {
    ...
    return function (t) {
      ...
      function c(t) {
        if (o("GoEasy() Create GoEasy object:" + h.stringify(t)), this._isEmpty(t.appkey)) return void("undefined" != typeof t.onConnectFailed && t.onConnectFailed({
          code: 400,
          content: "appkey is required"
        }));
        this._copyConfig(t);
        var e = this._subServerHost.replace("://", "://" + y.number()), n = e + ":" + this._subServerPort;
        this.socket = a.connect(n), this._callbackEvents(t)
      }

      var a = n(1), u = n(34), h = n(37), p = [], f = !1;
      ...
      d.prototype = {
        maxNumber: 10, number: function () {
          return l
        }, initialCurrentNumber: function () {
          return l = parseInt(i("goeasyNode")), l > 0 && l < this.maxNumber ? l += 1 : l = Math.floor(10 * Math.random() + 1), r("goeasyNode", l), l
        }
      };
      var y = new d;
      s.prototype = new Array, s.prototype.indexOfGuid = function (t) {
        for (var e = 0; e < this.length; e++) if (this[e] == t) return e;
        return -1
      }, s.prototype.unshiftGuid = function (t) {
        var e = !1, n = this.indexOfGuid(t);
        for (n > -1 && (e = !0, this.splice(n, 1)), this.unshift(t); this.length > 100;) this.pop();
        return e
      }, c.prototype = {
        debug: !1,
        socket: null,
        ...
        channels: [],
        _subServerHost: "https://hangzhou.goeasy.io",
        _subServerPort: "443",
        ...
        _copyConfig: function (t) {
          this._appkey = t.appkey, this._otp = t.otp, this._isEmpty(t.userId) ? (this._userId = "anonymous-" + Math.floor(1e5 * Math.random() + 1), t.userId = this._userId) : this._userId = this._trim(t.userId), this._isEmpty(t.username) ? (this._username = "", t.username = "") : this._username = this._trim(t.username), this._isEmpty(t.userData) ? this._userData = "" : this._userData = this._trim(t.userData), 1 == t.debug && (this.debug = !0)
        },
        subscribe: function (t) {
          if (o("subscribe() subscribe:" + h.stringify(t)), this._isEmpty(t.channel)) return o("subscribe() 'channel' is required."), void("undefined" != typeof t.onFailed && t.onFailed({
            code: 400,
            content: "channel is required"
          }));
          this.subscribeBuffer[t.channel] = t, o("subscribe() add subscription into subscribeBuffer:" + h.stringify(this.subscribeBuffer[t.channel]));
          var e = this;
        ...
        doSubscribe: function (t) {
          ...
          var e = this;
          if (200 == e.authorizeResult.code) if (this._isEmpty(t.channel)) o("doSubscribe() subscribe failed with empty channel"), e.sendlogs(), t.finish = !0; else {
            var n = {channel: t.channel, sid: e.authorizeResult.sid};
            o("doSubscribe() emit subscribe params:" + h.stringify(n)), e.socket.emit("subscribe", n, function (n) {
              o("doSubscribe() receive subscribe ack:" + h.stringify(n)), 1 != t.finish && (t.finish = !0, delete e.subscribeBuffer[t.channel], o("doSubscribe() delete subscription from subscribeBuffer:" + h.stringify(t)), 200 == n.resultCode ? (e.channels[t.channel] = t, "undefined" != typeof t.onSuccess && t.onSuccess()) : "undefined" != typeof t.onFailed && t.onFailed({
                code: n.resultCode,
                content: n.content
              }))
            })
          } else o("doSubscribe() return with authorize code:" + e.authorizeResult.code)
        },
        doSubscribeAndCheckAck: function (t) {
          o("doSubscribeAndCheckAck():" + h.stringify(t)), t.finish = !1;
          var e = this;
          e.doSubscribe(t);
          var n = window.setInterval(function () {
            t.finish || "connected" != e.networkStatus ? (o("doSubscribeAndCheckAck() clean doSubscribeAndCheckAck:" + h.stringify(t)), t.checking = !1, window.clearInterval(n)) : (o("doSubscribeAndCheckAck() retry doSubscribe:" + h.stringify(t)), e.doSubscribe(t))
          }, 1300)
        },
        ...
        unsubscribe: function (t) {
          function e() {
            200 == i.authorizeResult.code ? i.socket.emit("unsubscribe", {
              ...
              r = !0, 200 == e.resultCode ? (delete i.channels[t.channel], o("doUnsubscribe() delete from channels:" + h.stringify(t)), "undefined" != typeof t.onSuccess && t.onSuccess()) : "undefined" != typeof t.onFailed && t.onFailed({
                code: e.resultCode,
                content: e.content
              })
            }) : (r = !0, "undefined" != typeof t.onFailed && t.onFailed({
          ...
          function n() {
            e();
            var n = window.setInterval(function () {
              !r && "connected" == i.networkStatus && s < 0 ? (s++, e()) : s == i.maxRetries ? (window.clearInterval(n), "undefined" != typeof t.onFailed && t.onFailed({
                code: 408,
          ...
          var i = this, r = !1, s = 0;
          if (null != this.authorizeResult && "connected" == i.networkStatus) n(); else var c = window.setInterval(function () {
            null != i.authorizeResult && "connected" == i.networkStatus ? (window.clearInterval(c), n()) : (s++, s == i.maxRetries && (window.clearInterval(c), "undefined" != typeof t.onFailed && t.onFailed({
              code: 408,
              content: "Server unreachable or timeout"
            })))
          }, 1e3)
        ...
        publish: function (t) {
          ...
          function n() {
            ...
            var s = window.setInterval(function () {
              !i && r < o.maxRetries ? (r++, e(n)) : r == o.maxRetries ? (window.clearInterval(s), "undefined" != typeof t.onFailed && t.onFailed({
                code: 408,
                content: "Server unreachable or timeout"
          ...
          var o = this, i = !1, r = 0;
          if (null != this.authorizeResult && "connected" == o.networkStatus) n(); else var s = window.setInterval(function () {
            null != o.authorizeResult && "connected" == o.networkStatus ? (window.clearInterval(s), n()) : (r++, r == o.maxRetries && (window.clearInterval(s), "undefined" != typeof t.onFailed && t.onFailed({
              code: 408,
              content: "Server unreachable or timeout"
            })))
          }, 1e3)
        ...
        tryEmit: function (t, e, n, o) {
          ...
          var a = window.setInterval(function () {
            ...
            s || t ? (window.clearInterval(a), t && "undefined" != typeof n && n()) : (c++, i())
          }, 1e3)
        },
        _callbackEvents: function (t) {
          var e = this;
          this.socket.on("message", function (t, n) {
            e.receivedGuids.unshiftGuid(t.i) || (t.a && e.socket.emit("ack", {publishGuid: t.i}), e._endWith(t.n, "presence") ? "undefined" != typeof e.channels[t.n].onPresence && e.channels[t.n].onPresence(h.parse(t.c)) : "undefined" != typeof e.channels[t.n].onMessage && e.channels[t.n].onMessage({
              channel: t.n,
              content: t.c
            }))
          }), this.socket.on("connect", function () {
            function n() {
              o("doAuthorize() emit authorize params:" + h.stringify(i)), e._isEmpty(i.artifactVersion) && e.sendlogs(), e.socket.emit("authorize", i, function (n) {
                if (o("doAuthorize() received authorize ack:" + h.stringify(n)), !r) if (r = !0, e.authorizeStatus = "authorized", e._manualDisconnectStatus = "initial", null == e.authorizeResult && (e.authorizeResult = {}), e.authorizeResult.code = n.resultCode, e.authorizeResult.content = n.content, 200 == n.resultCode) {
                  if (null == e.authorizeResult.sid) e.authorizeResult.sid = n.sid; else if (e.authorizeResult.sid != n.sid) {
                    e.authorizeResult.sid = n.sid;
                    for (var i in e.channels) e.channels.hasOwnProperty(i) && (o("doAuthorize() sid expired and will call doSubscribeAndCheckAck from channels:" + h.stringify(e.channels[i])), e.doSubscribeAndCheckAck(e.channels[i]))
                  }
                  for (var s in e.subscribeBuffer) e.subscribeBuffer.hasOwnProperty(s) && (o("doAuthorize() will doSubscribeAndCheckAck from subscribeBuffer:" + h.stringify(e.subscribeBuffer[s])), e.doSubscribeAndCheckAck(e.subscribeBuffer[s]));
      ...
      function o(t, e) {
        ...
        var n, o = r(t), s = o.source, u = o.id, h = o.path, p = a[u] && h in a[u].nsps,
      ...
      t.exports = e = o;
      var a = e.managers = {};
      e.protocol = s.protocol, e.connect = o, e.Manager = n(7), e.Socket = n(29)
    }, function (t, e, n) {
      (function (e) {
        "use strict";
        ...
        function o(t, n) {
          var o = t;
          n = n || e.location, null == t && (t = n.protocol + "//" + n.host), "string" == typeof t && ("/" === t.charAt(0) && (t = "/" === t.charAt(1) ? n.protocol + t : n.host + t), /^(https?|wss?):\/\//.test(t) || (t = "undefined" != typeof n ? n.protocol + "//" + t : "https://" + t), o = i(t)), o.port || (/^(http|ws)$/.test(o.protocol) ? o.port = "80" : /^(http|ws)s$/.test(o.protocol) && (o.port = "443")), o.path = o.path || "/";
          var r = o.host.indexOf(":") !== -1, s = r ? "[" + o.host + "]" : o.host;
      ...
      function i(t) {
        var n = "" + t.type;
        return e.BINARY_EVENT !== t.type && e.BINARY_ACK !== t.type || (n += t.attachments + "-"), t.nsp && "/" !== t.nsp && (n += t.nsp + ","), null != t.id && (n += t.id), null != t.data && (n += JSON.stringify(t.data)), n
      }
      ...
      function s(t) {
        ...
        if (null == e.types[o.type]) return u();
        ...
        return t.charAt(++n) && (o = c(o, t.substr(n))), o
      }
      ...
      var h = (n(4)("socket.io-parser"), n(6));
      e.protocol = 4, e.types = ["CONNECT", "DISCONNECT", "EVENT", "ACK", "ERROR", "BINARY_EVENT", "BINARY_ACK"], e.CONNECT = 0, e.DISCONNECT = 1, e.EVENT = 2, e.ACK = 3, e.ERROR = 4, e.BINARY_EVENT = 5, e.BINARY_ACK = 6, e.Encoder = o, e.Decoder = r, o.prototype.encode = function (t, e) {
        var n = i(t);
        e([n])
      }, h(r.prototype), r.prototype.add = function (t) {
        var e;
        if ("string" != typeof t) throw new Error("Unknown type: " + t);
        e = s(t), this.emit("decoded", e)
      ...
      var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
          ...
          return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t
        }, r = n(8), s = n(29), c = n(6), a = n(5), u = n(31), h = n(32), p = (n(4)("socket.io-client:manager"), n(28)),
        f = n(33), l = Object.prototype.hasOwnProperty;
      t.exports = o, o.prototype.emitAll = function () {
        ...
        if (!1 !== this._timeout) {
          var c = this._timeout, a = setTimeout(function () {
            i.destroy(), n.close(), n.emit("error", "timeout"), o.emitAll("connect_timeout", c)
          }, c);
          this.subs.push({
            destroy: function () {
              clearTimeout(a)
      ...
      (function (e) {
        ...
        var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
          ...
          return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t
        }, s = n(11), c = n(6), a = (n(4)("engine.io-client:socket"), n(28)), u = n(15), h = n(3), p = n(21);
        t.exports = o, o.priorWebsocketSuccess = !1, c(o.prototype), o.protocol = u.protocol, o.Socket = o, o.Transport = n(14), o.transports = n(11), o.parser = n(15), o.prototype.createTransport = function (t) {
          ...
          function e() {
            ...
            h || (u.send([{type: "ping", data: "probe"}]), u.once("packet", function (t) {
              if (!h) if ("pong" === t.type && "probe" === t.data) {
                if (p.upgrading = !0, p.emit("upgrading", u), !u) return;
                o.priorWebsocketSuccess = "websocket" === u.name, p.transport.pause(function () {
                  h || "closed" !== p.readyState && (a(), p.setTransport(u), u.send([{type: "upgrade"}]), p.emit("upgrade", u), u = null, p.upgrading = !1, p.flush())
                })
              } else {
                var e = new Error("probe error");
                e.transport = u.name, p.emit("upgradeError", e)
              }
            }))
          }

          function n() {
            h || (h = !0, a(), u.close(), u = null)
          }

          function i(t) {
            var e = new Error("probe error: " + t);
            e.transport = u.name, n(), p.emit("upgradeError", e)
          }
          ...
          function a() {
            u.removeListener("open", e), u.removeListener("error", i), u.removeListener("close", r), p.removeListener("close", s), p.removeListener("upgrading", c)
          }

          var u = this.createTransport(t, {probe: 1}), h = !1, p = this;
      ...
      (function (t) {
        ...
        function o(e) {
          ...
          !1 !== e.jsonp;
          if (t.location) {
            var r = "https:" === location.protocol, s = location.port;
            s || (s = r ? 443 : 80), n = e.hostname !== location.hostname || s !== e.port, o = e.secure !== r
          }
          return e.xdomain = n, e.xscheme = o, new i(e)
        }
      ...
      (function (e) {
        ...
        function i(t) {
          r.call(this, t), this.query = this.query || {}, c || (e.___eio || (e.___eio = []), c = e.___eio), this.index = c.length;
          var n = this;
          c.push(function (t) {
            n.onData(t)
        ...
        t.exports = i;
        var c, a = /\n/g, u = /\\n/g;
        s(i, r), i.prototype.supportsBinary = !1, i.prototype.doClose = function () {
          ...
          if (!this.form) {
            ...
            s.className = "socketio", s.style.position = "absolute", s.style.top = "-1000px", s.style.left = "-1000px", s.target = h, s.method = "POST", s.setAttribute("accept-charset", "utf-8"), c.name = "d", s.appendChild(c), document.body.appendChild(s), this.form = s, this.area = c
          }
          this.form.action = this.uri(), o(), t = t.replace(u, "\\\n"), this.area.value = t.replace(a, "\\n");
          try {
            this.form.submit()
          } catch (p) {
          }
      ...
      var i = n(14), r = n(21), s = n(15), c = n(22), a = n(23);
      n(4)("engine.io-client:polling");
      t.exports = o;
      var u = function () {
        var t = n(24), e = new t({xdomain: !1});
      ...
      function i(t, e, n) {
        ...
        }, c = 0; c < t.length; c++) r(c, t[c], i)
      }

      var r = n(16), s = n(17), c = n(18);
      ...
      e.protocol = 3;
      var a = e.packets = {open: 0, close: 1, ping: 2, pong: 3, message: 4, upgrade: 5, noop: 6}, u = r(a),
        h = {type: "error", data: "parser error"};
      e.encodePacket = function (t, e, n, o) {
        "function" == typeof e && (o = e, e = !1), "function" == typeof n && (o = n, n = null);
        var i = (void 0 === t.data ? void 0 : t.data.buffer || t.data, a[t.type]);
        return void 0 !== t.data && (i += n ? c.encode(String(t.data), {strict: !1}) : String(t.data)), o("" + i)
      }, e.decodePacket = function (t, e, n) {
        if (void 0 === t) return h;
        if ("string" == typeof t) {
          if (n && (t = o(t), t === !1)) return h;
          var i = t.charAt(0);
          return Number(i) == i && u[i] ? t.length > 1 ? {type: u[i], data: t.substring(1)} : {type: u[i]} : h
        }
        var r = new Uint8Array(t), i = r[0], s = sliceBuffer(t, 1);
        return Blob && "blob" === e && (s = new Blob([s])), {type: u[i], data: s}
        ...
        return "function" == typeof n && (o = n, n = null), t.length ? void i(t, s, function (t, e) {
          return o(e.join(""))
        }) : o("0:")
        ...
        for (var r, s, c = "", a = 0, u = t.length; a < u; a++) {
          ...
          if (":" === p) {
            ...
            if (s.length) {
              if (i = e.decodePacket(s, n, !0), h.type === i.type && h.data === i.data) return o(h, 0, 1);
              var f = o(i, a + r, u);
              if (!1 === f) return
            }
            a += r, c = ""
      ...
      (function (t, i) {
        ...
        !function (s) {
          ...
          function a(t) {
            for (var e, n = t.length, o = -1, i = ""; ++o < n;) e = t[o], e > 65535 && (e -= 65536, i += S(e >>> 10 & 1023 | 55296), e = 56320 | 1023 & e), i += S(e);
            return i
          }
          ...
          function p(t, e) {
            ...
            var n = "";
            return 0 == (4294965248 & t) ? n = S(t >> 6 & 31 | 192) : 0 == (4294901760 & t) ? (u(t, e) || (t = 65533), n = S(t >> 12 & 15 | 224), n += h(t, 6)) : 0 == (4292870144 & t) && (n = S(t >> 18 & 7 | 240), n += h(t, 12), n += h(t, 6)), n += S(63 & t | 128)
          }

          function f(t, e) {
            e = e || {};
            for (var n, o = !1 !== e.strict, i = c(t), r = i.length, s = -1, a = ""; ++s < r;) n = i[s], a += p(n, o);
            return a
          }

          function l() {
            if (w >= k) throw Error("Invalid byte index");
            var t = 255 & v[w];
            if (w++, 128 == (192 & t)) return 63 & t;
          ...
          function d(t) {
            ...
            if (192 == (224 & e)) {
              if (n = l(), r = (31 & e) << 6 | n, r >= 128) return r;
              throw Error("Invalid continuation byte")
            }
            if (224 == (240 & e)) {
              if (n = l(), o = l(), r = (15 & e) << 12 | n << 6 | o, r >= 2048) return u(r, t) ? r : 65533;
              throw Error("Invalid continuation byte")
            }
            if (240 == (248 & e) && (n = l(), o = l(), i = l(), r = (7 & e) << 18 | n << 12 | o << 6 | i, r >= 65536 && r <= 1114111)) return r;
          ...
          function y(t, e) {
            e = e || {};
            var n = !1 !== e.strict;
            v = c(t), k = v.length, w = 0;
            for (var o, i = []; (o = d(n)) !== !1;) i.push(o);
            return a(i)
          }

          var m = "object" == r(e) && e, g = "object" == r(t) && t && t.exports == m && t,
            b = "object" == ("undefined" == typeof i ? "undefined" : r(i)) && i;
          b.global !== b && b.window !== b || (s = b);
          var v, k, w, S = String.fromCharCode, _ = {version: "2.1.2", encode: f, decode: y};
          if ("object" == r(n(20)) && n(20)) o = function () {
            return _
          }.call(e, n, e, t), !(void 0 !== o && (t.exports = o)); else if (m && !m.nodeType) if (g) g.exports = _; else {
            var x = {}, C = x.hasOwnProperty;
            for (var E in _) C.call(_, E) && (m[E] = _[E])
          } else s.utf8 = _
        }(void 0)
      ...
      function o(t) {
        var e = 0;
        for (h = 0; h < t.length; h++) e = e * c + a[t.charAt(h)];
        return e
      }
      ...
      for (var r, s = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_".split(""), c = 64, a = {}, u = 0, h = 0; h < c; h++) a[s[h]] = h;
      ...
      (function (e) {
        ...
        var o = n(25);
        t.exports = function (t) {
          var n = t.xdomain, i = t.xscheme, r = t.enablesXDR;
          try {
      ...
      (function (e) {
        ...
        function o(t) {
          var e = t && t.forceBase64;
          e && (this.supportsBinary = !1), this.perMessageDeflate = t.perMessageDeflate, this.usingBrowserWebSocket = h && !t.forceNode, this.protocols = t.protocols, this.usingBrowserWebSocket || (f = i), r.call(this, t)
        }

        var i, r = n(14), s = n(15), c = n(21), a = n(22), u = n(23),
          h = (n(4)("engine.io-client:websocket"), e.WebSocket || e.MozWebSocket);
        if ("undefined" == typeof window) try {
          i = n(27)
        } catch (p) {
        }
        var f = h;
        f || "undefined" != typeof window || (f = i), t.exports = o, a(o, r), o.prototype.name = "websocket", o.prototype.supportsBinary = !0, o.prototype.doOpen = function () {
          if (this.check()) {
          ...
          var o = this;
          this.writable = !1;
          for (var i = t.length, r = 0, c = i; r < c; r++) !function (t) {
            s.encodePacket(t, o.supportsBinary, function (r) {
              if (!o.usingBrowserWebSocket) {
                var s = {};
                if (t.options && (s.compress = t.options.compress), o.perMessageDeflate) {
      ...
      var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
        ...
        return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t
      }, r = n(5), s = n(6), c = n(30), a = n(31), u = n(32), h = (n(4)("socket.io-client:socket"), n(21));
      t.exports = e = o;
      var p = {
        connect: 1,
        connect_error: 1,
      ...
      s(o.prototype), o.prototype.subEvents = function () {
        ...
        var e = c(arguments), n = {type: r.EVENT, data: e};
        ...
        return function () {
          if (!n) {
            n = !0;
            var o = c(arguments);
            e.packet({type: r.ACK, id: t, data: o})
          }
        }
      ...
      function o(t, e, n) {
        var o = e && n || 0, i = e || [];
        t = t || {};
        var s = void 0 !== t.clockseq ? t.clockseq : a, p = void 0 !== t.msecs ? t.msecs : (new Date).getTime(),
          f = void 0 !== t.nsecs ? t.nsecs : h + 1, l = p - u + (f - h) / 1e4;
        if (l < 0 && void 0 === t.clockseq && (s = s + 1 & 16383), (l < 0 || p > u) && void 0 === t.nsecs && (f = 0), f >= 1e4) throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
        u = p, h = f, a = s, p += 122192928e5;
        var d = (1e4 * (268435455 & p) + f) % 4294967296;
        i[o++] = d >>> 24 & 255, i[o++] = d >>> 16 & 255, i[o++] = d >>> 8 & 255, i[o++] = 255 & d;
        var y = p / 4294967296 * 1e4 & 268435455;
        i[o++] = y >>> 8 & 255, i[o++] = 255 & y, i[o++] = y >>> 24 & 15 | 16, i[o++] = y >>> 16 & 255, i[o++] = s >>> 8 | 128, i[o++] = 255 & s;
        for (var m = t.node || c, g = 0; g < 6; ++g) i[o + g] = m[g];
        return e ? e : r(i)
      }

      var i = n(35), r = n(36), s = i(), c = [1 | s[0], s[1], s[2], s[3], s[4], s[5]], a = 16383 & (s[6] << 8 | s[7]),
        u = 0, h = 0;
      t.exports = o
    }, function (t, e) {
      (function (e) {
